...
public class DataValue {
     ...
     * 字符1
     */
    @Column(name = "DATA_STRING1", length = 500)
    private String data_String1;
    /**
     * 字符2
     */
    @Column(name = "DATA_STRING2", length = 500)
    private String data_String2;
    /**
     * 字符3
     */
    @Column(name = "DATA_STRING3", length = 500)
    private String data_String3;
    /**
     * 字符4
     */
    @Column(name = "DATA_STRING4", length = 500)
    private String data_String4;
    /**
     * 字符5
     */
    @Column(name = "DATA_STRING5", length = 500)
     ...
     * 备注
     */
    @Column(name = "DATA_REMARK", length = 500)
