...
public class DataDictionary {
     ...
     * 字符1
     */
    @Column(name = "DICTIONARY_STRING1", length = 500)
    private String dictionary_String1;
    /**
     * 字符2
     */
    @Column(name = "DICTIONARY_STRING2", length = 500)
    private String dictionary_String2;
    /**
     * 字符3
     */
    @Column(name = "DICTIONARY_STRING3", length = 500)
    private String dictionary_String3;
    /**
     * 字符4
     */
    @Column(name = "DICTIONARY_STRING4", length = 500)
    private String dictionary_String4;
    /**
     * 字符5
     */
    @Column(name = "DICTIONARY_STRING5", length = 500)
     ...
     * 备注
     */
    @Column(name = "DICTIONARY_REMARK", length = 500)
